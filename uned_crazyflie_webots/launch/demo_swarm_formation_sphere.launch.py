...
def generate_launch_description():
    ...
    config_path = os.path.join(general_package_dir, 'resources', 'demo_swarm_formation_distance_five_sphere.yaml')
    rviz_config_path = os.path.join(general_package_dir, 'rviz', 'sphere.rviz')
