		...
		\begin{tabular}{|c|c|c|c|c|}
			...
			\multirow{3}{*}{Rate}		& $p$		& $70.0$ 	& $0.0$ 	& $0.0$ \\ \cline{2-5}
										& $q$ 		& $70.0$ 	& $0.0$ 	& $0.0$ \\ \cline{2-5}
			 							& $r$ 		& $70.0$ 	& $16.7$ 	& $0.0$ \\ \hline
		\end{tabular}
		\caption{Controladores PID discreto. Parámetros. ACTUALIZAR}
